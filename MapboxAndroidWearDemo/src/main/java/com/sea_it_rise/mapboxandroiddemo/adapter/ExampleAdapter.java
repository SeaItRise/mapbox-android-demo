...
public class ExampleAdapter extends WearableRecyclerView.Adapter<ExampleAdapter.ViewHolder> {
  ...
  static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    ViewHolder(View view) {
      super(view);
      textView = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.text_item);
      imageView = (ImageView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.item_image);
    }
  ...
  public ExampleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new ViewHolder(LayoutInflater.from(parent.getContext())
      .inflate(com.sea_it_rise.mapboxandroiddemo.R.layout.item_curved_layout, parent, false));
  }
