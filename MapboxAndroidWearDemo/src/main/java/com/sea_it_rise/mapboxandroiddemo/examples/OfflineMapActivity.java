...
public class OfflineMapActivity extends WearableActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.simple_offline_map);
    ...
    downloadRegion = (Button) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.downloadRegionButton);
    listRegions = (Button) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.listRegionsButton);
    // Assign progressBar for later use
    progressBar = (ProgressBar) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.progress_bar);
  }
