...
public class AdjustLayerOpacityActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_style_adjust_layer_opacity);

    final SeekBar opacitySeekBar = (SeekBar) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.seek_bar_layer_opacity);
    final TextView percentTextView = (TextView) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.textview_opacity_value);
