...
public class ImageSourceActivity extends AppCompatActivity implements OnMapReadyCallback {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_image_source);
  ...
  public void onMapReady(MapboxMap mapboxMap) {
    ...
    mapboxMap.addSource(new ImageSource(ID_IMAGE_SOURCE, quad, com.sea_it_rise.mapboxandroiddemo.R.drawable.southeast_radar_0));
  ...
  private static class RefreshImageRunnable implements Runnable {
    ...
    RefreshImageRunnable(MapboxMap mapboxMap, Handler handler) {
      ...
      drawables = new int[4];
      drawables[0] = com.sea_it_rise.mapboxandroiddemo.R.drawable.southeast_radar_0;
      drawables[1] = com.sea_it_rise.mapboxandroiddemo.R.drawable.southeast_radar_1;
      drawables[2] = com.sea_it_rise.mapboxandroiddemo.R.drawable.southeast_radar_2;
      drawables[3] = com.sea_it_rise.mapboxandroiddemo.R.drawable.southeast_radar_3;
      drawableIndex = 1;
    }
