package com.sea_it_rise.mapboxandroiddemo.examples.camera;
...
public class BoundingBoxCameraActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_camera_bounding_box);
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(final MapboxMap mapboxMap) {
        ...
        Toast.makeText(
          ...
          getString(com.sea_it_rise.mapboxandroiddemo.R.string.tap_on_map_instruction),
          Toast.LENGTH_LONG
        ).show();
