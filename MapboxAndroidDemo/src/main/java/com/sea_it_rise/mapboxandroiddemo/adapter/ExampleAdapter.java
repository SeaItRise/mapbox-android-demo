package com.sea_it_rise.mapboxandroiddemo.adapter;
...
public class ExampleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    // create a new view
    View view = LayoutInflater.from(parent.getContext()).inflate(com.sea_it_rise.mapboxandroiddemo.R.layout.item, parent, false);
    View view1 = LayoutInflater.from(parent.getContext()).inflate(
      com.sea_it_rise.mapboxandroiddemo.R.layout.layout_description_item, parent, false);
    View view2 = LayoutInflater.from(parent.getContext()).inflate(
      com.sea_it_rise.mapboxandroiddemo.R.layout.layout_mas_description_card, parent, false);
    View view3 = LayoutInflater.from(parent.getContext()).inflate(
      com.sea_it_rise.mapboxandroiddemo.R.layout.layout_query_description_card, parent, false);
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    if (detailItem.getShowNewIcon()) {
      viewHolder.newIconImageView.setImageDrawable(ContextCompat.getDrawable(context, com.sea_it_rise.mapboxandroiddemo.R.drawable.new_icon));
    } else {
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(final View itemView) {
      ...
      imageView = (ImageView) itemView.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.example_image);
      titleTextView = (TextView) itemView.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.example_title);
      descriptionTextView = (TextView) itemView.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.example_description);
      newIconImageView = (ImageView) itemView.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.new_icon_image_view);
    }
  }
