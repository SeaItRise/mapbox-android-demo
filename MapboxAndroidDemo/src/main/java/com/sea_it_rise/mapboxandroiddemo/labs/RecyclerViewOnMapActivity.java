...
public class RecyclerViewOnMapActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_lab_recycler_view_on_map);

    recyclerView = (RecyclerView) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.rv_on_top_of_map);

    Toast.makeText(this, com.sea_it_rise.mapboxandroiddemo.R.string.toast_instruction, Toast.LENGTH_SHORT).show();
  ...
  private ArrayList<SingleRecyclerViewLocation> setUpLists() {
    ...
    for (int x = 0; x < 7; x++) {
      ...
      singleLocation.setName(String.format(getString(com.sea_it_rise.mapboxandroiddemo.R.string.rv_card_name), x));
      singleLocation.setBedInfo(String.format(getString(com.sea_it_rise.mapboxandroiddemo.R.string.rv_card_bed_info), x));
      singleLocation.setLocationCoordinates(coordinates[x]);
      locationList.add(singleLocation);

      mapboxMap.addMarker(new MarkerOptions()
          .position(coordinates[x])
          .title(String.format(getString(com.sea_it_rise.mapboxandroiddemo.R.string.rv_card_name), x))
          .snippet(String.format(getString(com.sea_it_rise.mapboxandroiddemo.R.string.rv_card_bed_info), x)));
    }
    return locationList;
  }
  ...
  static class LocationRecyclerViewAdapter extends
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View itemView = LayoutInflater.from(parent.getContext())
          .inflate(com.sea_it_rise.mapboxandroiddemo.R.layout.rv_on_top_of_map_card, parent, false);
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
      ...
      MyViewHolder(View view) {
        super(view);
        name = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.location_title_tv);
        numOfBeds = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.location_num_of_beds_tv);
