package com.sea_it_rise.mapboxandroiddemo.examples.dds;
...
public class StyleCirclesCategoricallyActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_dds_style_circles_categorically);
