package com.sea_it_rise.mapboxandroiddemo.labs;
...
public class RecyclerViewSymbolLayerActivity extends AppCompatActivity implements OnMapReadyCallback {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_rv_symbol_layer);

    recyclerView = (RecyclerView) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.rv_on_top_of_map);
  ...
  private void handleClickCallout(Feature feature, PointF screenPoint, PointF symbolScreenPoint) {
    ...
    View textContainer = view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.title);
  ...
  private static class GenerateViewIconTask extends AsyncTask<FeatureCollection, Void, HashMap<String, Bitmap>> {
    ...
    protected HashMap<String, Bitmap> doInBackground(FeatureCollection... params) {
      ...
      for (Feature feature : featureCollection.getFeatures()) {
        View view = inflater.inflate(com.sea_it_rise.mapboxandroiddemo.R.layout.layout_callout, null);

        String name = feature.getStringProperty(PROPERTY_TITLE);
        TextView textView = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.title);
        textView.setText(name);

        boolean favourite = feature.getBooleanProperty(PROPERTY_FAVOURITE);
        ImageView imageView = (ImageView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.logoView);
        imageView.setImageResource(favourite ? com.sea_it_rise.mapboxandroiddemo.R.drawable.ic_favorite : com.sea_it_rise.mapboxandroiddemo.R.drawable.ic_favorite_border);
  ...
  static class LocationRecyclerViewAdapter extends RecyclerView.Adapter<LocationRecyclerViewAdapter.MyViewHolder> {
    ...
    public LocationRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View itemView = LayoutInflater.from(parent.getContext())
        .inflate(com.sea_it_rise.mapboxandroiddemo.R.layout.cardview_symbol_layer, parent, false);
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
      ...
      MyViewHolder(View view) {
        super(view);
        title = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.textview_title);
        poi = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.textview_poi);
        style = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.textview_style);
        description = (TextView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.textview_description);
        singleCard = (CardView) view.findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.single_location_cardview);
