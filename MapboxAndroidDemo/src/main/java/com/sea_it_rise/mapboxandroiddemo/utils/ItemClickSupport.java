...
public class ItemClickSupport {
  ...
  private ItemClickSupport(RecyclerView recyclerView) {
    ...
    this.recyclerView.setTag(com.sea_it_rise.mapboxandroiddemo.R.id.item_click_support, this);
    this.recyclerView.addOnChildAttachStateChangeListener(attachListener);
  }

  public static ItemClickSupport addTo(RecyclerView view) {
    ItemClickSupport support = (ItemClickSupport) view.getTag(com.sea_it_rise.mapboxandroiddemo.R.id.item_click_support);
    if (support == null) {
  ...
  private void detach(RecyclerView view) {
    ...
    view.setTag(com.sea_it_rise.mapboxandroiddemo.R.id.item_click_support, null);
  }
