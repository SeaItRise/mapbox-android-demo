...
public class GeoJsonClusteringActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_geojson_clustering);
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(MapboxMap map) {
        ...
        Toast.makeText(GeoJsonClusteringActivity.this, com.sea_it_rise.mapboxandroiddemo.R.string.zoom_map_in_and_out_instruction,
  ...
  private void addClusteredGeoJsonSource() {
    ...
    int[][] layers = new int[][] {
      new int[] {150, ContextCompat.getColor(this, com.sea_it_rise.mapboxandroiddemo.R.color.mapboxRed)},
      new int[] {20, ContextCompat.getColor(this, com.sea_it_rise.mapboxandroiddemo.R.color.mapboxGreen)},
      new int[] {0, ContextCompat.getColor(this, com.sea_it_rise.mapboxandroiddemo.R.color.mapbox_blue)}
    };
