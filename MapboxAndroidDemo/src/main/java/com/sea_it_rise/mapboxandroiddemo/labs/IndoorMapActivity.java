...
public class IndoorMapActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_lab_indoor_map);
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(final MapboxMap mapboxMap) {
        ...
        levelButtons = findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.floor_level_buttons);
    ...
    Button buttonSecondLevel = (Button) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.second_level_button);
    ...
    Button buttonGroundLevel = (Button) findViewById(com.sea_it_rise.mapboxandroiddemo.R.id.ground_level_button);
