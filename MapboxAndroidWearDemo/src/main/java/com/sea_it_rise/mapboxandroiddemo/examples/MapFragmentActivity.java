...
public class MapFragmentActivity extends WearableActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.sea_it_rise.mapboxandroiddemo.R.layout.activity_basic_support_map_frag);
    ...
    if (savedInstanceState == null) {
      ...
      transaction.add(com.sea_it_rise.mapboxandroiddemo.R.id.container, mapFragment, "com.mapbox.map");
      transaction.commit();
    } else {
